...
{
    public partial class CustomerInforForm : Form
    {
        private Customer customer = new Customer();
        public CustomerInforForm()
        {
            InitializeComponent();
        }
        ...
        private void CustomerInforForm_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = this.customer.getInfoCustomerByRoomID(Globals.GlobalRoomId);
